...
public class ManagementConsole extends Thread {
	...
	void executeLoadWithAnnotations(String servletInternalName) {
	    String servletDir = MyHttpServer.DYNAMIC_WEB_ROOT + File.separator + servletInternalName;
	    File classFolder = new File(servletDir + File.separator + "class");

	 

	    if (!classFolder.exists()) {
	        System.out.println("Class folder not found for servlet: " + servletInternalName);
	        return;
	    }

	 

	    // Scansiona il contenuto della cartella "class" e carica le classi con annotazioni
	        ...
	        for (File classFile : classFiles) {
	            ...
	            try {
	                ...
	                if (annotation != null) {
	                    ...
	                    ServletHashTable.put(annotation.name(), servlet);
	                    System.out.println("Servlet " + annotation.name() + " added");
	                }
	            } catch (ClassNotFoundException | IllegalAccessException | InstantiationException e) {
	                System.out.println("Failed to load servlet class: " + className);
	                e.printStackTrace();
	            }
	        }
	    } else {
	        System.out.println("No .class files found in the 'class' folder for servlet: " + servletInternalName);
	    }
	}
